<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyFaculty.aspx.cs" Inherits="ModifyFaculty" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Update Faculty Mentor</title>
...
<body style="text-align:center">
    ...
    <h1 style="text-align:center; font-family:'Century Gothic'; color:rgb(185, 78, 176);text-shadow: 1px 1px 1px #000000; font-size:50px"><b>Modify Faculty Mentor</b></h1>
