<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Inserting3.aspx.cs" Inherits="Inserting3" %>
...
<body style="text-align:center">
    ...
    <h1 style="text-align:center; font-family:'Century Gothic'; color:rgb(185, 78, 176);text-shadow: 1px 1px 1px #000000; font-size:50px"><b>Add new Event</b></h1>
    ...
    <table style="width:100%">
        ...
        <asp:Button ID="Button1" CssClass="BtnClass" runat="server" Text="Add Event" OnClick="Button1_Click"/>
    </form>
</body>
</html>
