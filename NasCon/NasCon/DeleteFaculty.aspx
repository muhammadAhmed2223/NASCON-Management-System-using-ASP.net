<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteFaculty.aspx.cs" Inherits="DeleteFaculty" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title> Delete - Faculty Mentor </title>
...
<body style="text-align:center;">
    ...
    <h1 style="text-align:center; font-family:'Century Gothic'; color:rgb(185, 78, 176);text-shadow: 1px 1px 1px #000000; font-size:50px"><b>Delete Faculty</b></h1>

    <br /><br />


    <form id="form1" runat="server">
        Enter FACULTY ID: <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
