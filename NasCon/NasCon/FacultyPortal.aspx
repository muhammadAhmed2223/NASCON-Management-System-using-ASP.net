<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FacultyPortal.aspx.cs" Inherits="FacultyPortal" %>
...
<body>
    ...
    <br />
     ...
     <h1 style="text-align:center; font-family:'Century Gothic'; color:rgb(185, 78, 176);text-shadow: 1px 1px 1px #000000; font-size:50px"><b>Faculty Portal</b></h1>
        ...
        <tr>
                <td>
                    <div class="image-button">
                        <a href="FacultyEvent.aspx?ID=<%=ID %>" style=" font-size:xx-large; width:100%">
                            <img src ="Event.jpg" style="height:350px; width:450px" />
                            <br />
                            <div style=" position: absolute; bottom: 8px; color:chocolate; background-color:rgba(256,256,256,0.9); width:inherit; box-shadow:  0px 8px 16px 0px rgba(0,0,0,0.2);text-shadow: 1px 1px 2px #000000;">Events</div>
                        </a>
                    </div>
                </td>
                <td>
                    <div class="image-button">
                        <a href="FacultyReports.aspx?ID=<%=ID %>" style=" font-size:xx-large; width:100%">
