<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Inserting2.aspx.cs" Inherits="Inserting2" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Add Faculty Mentor</title>
...
<body style="text-align:center">
    ...
    <h1 style="text-align:center; font-family:'Century Gothic'; color:rgb(185, 78, 176);text-shadow: 1px 1px 1px #000000; font-size:50px"><b>Add new Mentor</b></h1>
    ...
    <table style="width:100%">
        ...
        <asp:Button ID="Button1" CssClass="BtnClass" runat="server" Text="Add" OnClick="Button1_Click"/>
    </form>
</body>
</html>
