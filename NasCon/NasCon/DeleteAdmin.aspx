<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteAdmin.aspx.cs" Inherits="DeleteAdmin" %>
...
<body style="text-align:center;">
    ...
    <h1 style="text-align:center; font-family:'Century Gothic'; color:rgb(185, 78, 176);text-shadow: 1px 1px 1px #000000; font-size:50px"><b>Delete Admin</b></h1>

    <br /><br />


    <form id="form1" runat="server">
        Enter Admin ID: <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
